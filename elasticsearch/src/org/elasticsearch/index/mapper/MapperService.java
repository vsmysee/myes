...
public class MapperService extends AbstractIndexComponent implements Iterable<DocumentMapper> {
    ...
    /**
     * Returns {@link FieldMappers} for all the {@link org.elasticsearch.index.mapper.FieldMapper}s that are registered
    ...
    /**
     * Returns the {@link FieldMappers} of all the {@link org.elasticsearch.index.mapper.FieldMapper}s that are
     * registered under the give fullName ({@link org.elasticsearch.index.mapper.FieldMapper#fullName()} across
