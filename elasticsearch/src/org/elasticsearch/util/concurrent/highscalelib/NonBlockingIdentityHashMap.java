 ...
 * operations.  {@link org.elasticsearch.util.concurrent.highscalelib.NonBlockingHashMap} scales substatially better than
...
public class NonBlockingIdentityHashMap<TypeK, TypeV>
     ...
     * iteration.  The {@link org.elasticsearch.util.concurrent.highscalelib.NonBlockingIdentityHashMap} does not normally create or
    ...
    public Set<Entry<TypeK, TypeV>> entrySet() {
        return new AbstractSet<Entry<TypeK, TypeV>>() {
            ...
            @Override public Iterator<Entry<TypeK, TypeV>> iterator() {
