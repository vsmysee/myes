 ...
 * {@link java.util.concurrent.BrokenBarrierException} thrown by a {@link #reset()} operation defined
 * by {@link java.util.concurrent.CyclicBarrier}.
 * <p/>
 * <p/>
 * <b>Sample usage:</b> <br>
...
public class ThreadBarrier extends CyclicBarrier {
    /**
     * The cause of a {@link java.util.concurrent.BrokenBarrierException} and {@link java.util.concurrent.TimeoutException}
     ...
     * was broken, a {@link java.util.concurrent.BrokenBarrierException} will be thrown. Otherwise,
     * would return gracefully.
     *
     * @throws java.util.concurrent.BrokenBarrierException With a nested broken cause.
     */
     ...
     *
     * @throws java.util.concurrent.BrokenBarrierException an empty BrokenBarrierException.
     */
    ...
    /**
     * A Barrier action to be used in conjunction with {@link org.elasticsearch.util.concurrent.ThreadBarrier} to
     ...
     * Measurement.
     *
     * @see org.elasticsearch.util.concurrent.ThreadBarrier#ThreadBarrier(int, Runnable)
     *      <p/>
