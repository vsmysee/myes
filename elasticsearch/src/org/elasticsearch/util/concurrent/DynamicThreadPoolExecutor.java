...
/**
 * An {@link java.util.concurrent.ExecutorService} that executes each submitted task using one of
 * possibly several pooled threads, normally configured using
 * {@link org.elasticsearch.util.concurrent.DynamicExecutors} factory methods.
 *
 * @author moran
 * @since 6.5
 */
public class DynamicThreadPoolExecutor extends ThreadPoolExecutor {
    ...
    /**
     * Much like a {@link java.util.concurrent.SynchronousQueue} which acts as a rendezvous channel. It
     ...
     * {@link java.util.concurrent.RejectedExecutionHandler} policies:
     * <ol>
     * <li> {@link org.elasticsearch.util.concurrent.DynamicThreadPoolExecutor.ForceQueuePolicy} - forces the queue to accept the rejected task. </li>
     * <li> {@link org.elasticsearch.util.concurrent.DynamicThreadPoolExecutor.TimedBlockingPolicy} - waits for a given time for the task to be
     * executed.</li>
     * </ol>
     *
