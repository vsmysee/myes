...
import org.elasticsearch.util.gnu.trove.TDoubleIntHashMap;
import org.elasticsearch.util.gnu.trove.TDoubleIntIterator;
...
public class TDoubleIntHashMapDecorator extends AbstractMap<Double, Integer>
    ...
    public Set<Entry<Double, Integer>> entrySet() {
        return new AbstractSet<Entry<Double, Integer>>() {
            ...
            public boolean addAll(Collection<? extends Entry<Double, Integer>> c) {
                throw new UnsupportedOperationException();
            }
